    ...
    sealed class custom
    {
        ...
        public static void mofombc(string ma)
        {
            if (ma.Contains("PN"))
            {
                ...
                var frm = new ChucNang.f_pnhap();
                frm.ShowDialog();
            }
            else if (ma.Contains("BH"))
            {
                layquyen("btnbanhang");
                Biencucbo.xembc = true;
                var frm = new ChucNang.f_banhang();
                frm.ShowDialog();
            }
            else if (ma.Contains("PT"))
            {
                layquyen("btnpthu");
                Biencucbo.xembc = true;
                var frm = new ChucNang.f_pthutien();
                frm.ShowDialog();
            }
